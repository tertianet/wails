...
import (
	...
	"github.com/tertianet/wails/v2/cmd/wails/flags"
	"github.com/tertianet/wails/v2/internal/colour"
	"github.com/tertianet/wails/v2/internal/shell"

	"github.com/tertianet/wails/v2/internal/github"
)
...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/tertianet/wails/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/tertianet/wails/v2 " + desiredVersion))
